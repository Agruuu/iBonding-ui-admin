/**
 * Determine whether or not Hexadecimal color value.
...
/**
 * RGB Convert color values to Hexadecimal color value.
 * The values of `r`, `g`, and `b` need to be in the range of `[0, 255]`.
 *
