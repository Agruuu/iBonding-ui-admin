  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="Code" prop="code">
        <el-input v-model="formData.code" placeholder="Please enter the role code" />
      </el-form-item>
      <el-form-item label="Sort" prop="sort">
        <el-input v-model="formData.sort" placeholder="Please enter the display order" />
      </el-form-item>
...
const formRules = reactive({
  ...
  code: [{ required: true, message: 'Role code cannot be empty', trigger: 'change' }],
  ...
  remark: [{ required: false, message: 'Remarks cannot be empty', trigger: 'blur' }]
})
