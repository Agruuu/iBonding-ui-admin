  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="Name" prop="name">
        <el-input v-model="formData.name" placeholder="Please enter the tool name" />
      </el-form-item>
      <el-form-item label="Description" prop="description">
        <el-input type="textarea" v-model="formData.description" placeholder="Please enter the tool description" />
      </el-form-item>
...
const formRules = reactive({
  name: [{ required: true, message: 'Tool name cannot be empty', trigger: 'blur' }]
})
