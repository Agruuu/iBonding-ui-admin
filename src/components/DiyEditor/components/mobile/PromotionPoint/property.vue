<template>
  <ComponentContainerProperty v-model="formData.style">
    <el-form :model="formData" label-width="80px">
      <el-card class="property-group" header="Point Mall Activity" shadow="never">
        <PointShowcase v-model="formData.activityIds" />
      </el-card>
      <el-card class="property-group" header="Product Style" shadow="never">
      ...
      <el-card class="property-group" header="Badge" shadow="never">
        <el-form-item label="Badge" prop="badge.show">
          <el-switch v-model="formData.badge.show" />
        </el-form-item>
        <el-form-item v-if="formData.badge.show" label="Badge" prop="badge.imgUrl">
          <UploadImg v-model="formData.badge.imgUrl" height="44px" width="72px">
            <template #tip> Suggested Size：36 * 22</template>
          </UploadImg>
        </el-form-item>
      </el-card>
      <el-card class="property-group" header="Button" shadow="never">
