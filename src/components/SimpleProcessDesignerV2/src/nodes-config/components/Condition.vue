<template>
  <el-form ref="formRef" :model="condition" :rules="formRules" label-position="top">
    <el-form-item label="Condition Type" prop="conditionType">
    ...
    <el-form-item v-if="condition.conditionType === ConditionType.RULE && condition.conditionGroups" label="Condition Rule">
      <div class="condition-group-tool">
        <div class="flex items-center">
          <div class="mr-4">Conditional Group Relationship</div>
          <el-switch
        ...
        >
          ...
          <template #header>
            <div class="flex items-center justify-between">
              ...
              <div class="flex">
                <div class="mr-4">Rule Relationship</div>
                <el-switch
          ...
          <div class="flex pt-2" v-for="(rule, rIdx) in equation.rules" :key="rIdx">
            <div class="mr-2">
              <el-form-item
                ...
                :rules="{
                  required: true,
                  message: 'Left value cannot be empty',
                  trigger: 'change'
                }"
              >
            ...
            <div class="mr-2">
              <el-form-item
                ...
                :rules="{
                  required: true,
                  message: 'Right value cannot be empty',
                  trigger: 'blur'
                }"
              >
...
const formType = inject<Ref<number>>('formType') // form types 
const conditionConfigTypes = computed(() => {
  return CONDITION_CONFIG_TYPES.filter((item) => {
    // Temporarily remove the conditional rule option from the business form
...
/** Selectable form fields for conditional rules. */
const fieldOptions = useFormFieldsAndStartUser()

// Form validation rules.
const formRules = reactive({
  conditionType: [{ required: true, message: 'The condition type cannot be empty', trigger: 'blur' }],
  conditionExpression: [{ required: true, message: 'The condition expression cannot be empty', trigger: 'blur' }]
})
const formRef = ref() // form  Ref

/** Switching condition configuration method */
