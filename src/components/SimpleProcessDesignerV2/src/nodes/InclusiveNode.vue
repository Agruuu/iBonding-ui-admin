...
const moveNode = (index: number, to: number) => {
  // -1 ：towards the left  1： towards the right
...
const recursiveFindParentNode = (
  ...
  // The conditional node (`NodeType.CONDITION_NODE`) is rather special. It is necessary to call its parent conditional branch node (`NodeType.INCLUSIVE_BRANCH_NODE`) to continue the search.
