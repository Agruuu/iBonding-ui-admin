...
const recursiveFindParentNode = (
  ...
  // The conditional node (`NodeType.CONDITION_NODE`) is quite special. It's necessary to call its parent conditional branch node (`NodeType.EXCLUSIVE_NODE`) to continue the search.
